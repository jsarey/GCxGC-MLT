...
%
% J. Samuel Arey and Jonas Gros, EPFL, 2017.
%
...
switch prompt_output
 ...
 case {'verbose'}
 otherwise 
 disp('The prompt_output variable is not properly set in file main.m');
 cd('../users');
 return;
end
...
if ~exist(['../',input_path,Weathered_chromatogram_file],'file')
    error(['Weathered chromatogram file (',['../users/input/',Weathered_chromatogram_file],' ) does not exist.'])
end
